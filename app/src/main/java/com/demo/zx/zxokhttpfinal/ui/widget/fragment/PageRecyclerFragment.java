...
public class PageRecyclerFragment extends BaseFragment {
   ...
   // private NewGameListAdapter mNewGameListAdapter;
    ...
    public static PageRecyclerFragment newInstance(int position) {
        PageRecyclerFragment fragment = new PageRecyclerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_page_recycler, container, false);
        ...
        rvGame.setAdapter(mSuperPtrFrameLayoutAdapter);
    ...
    private boolean checkCanRefresh() {
        if (mSuperPtrFrameLayoutAdapter.getItemCount() == 0 || rvGame == null) {
            return true;
        }
        if (rvGame.getChildCount() == 0) {
            return true;
        }
        return rvGame.getChildAt(0).getTop() == 0;
    }
    @Override
